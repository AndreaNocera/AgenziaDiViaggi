...
public class Prenotazione {
	...
	public Biglietto getBigliettoById(Integer idBiglietto) throws PrenotazioneException {
	...
	public Biglietto getBigliettoByValue(Traveler traveler)	throws PrenotazioneException {
		for (Biglietto biglietto : listaBiglietti) {
