...
import voyager.nove.control.ControllerGestionePrenotazione;
...
public class BoundaryVenditore_GestionePrenotazione {
	...
	//Entita'
	private ControllerGestionePrenotazione controllore;
    ...
    public BoundaryVenditore_GestionePrenotazione(JPanel panelNext){
		...
		controllore = ControllerGestionePrenotazione.getInstance();
