...
public class UtenteSRLZDAO implements UtenteDAO {

	private static UtenteSRLZDAO singletonUtenteDAO = null; 
	private static SerializationManager serializationManager = null;

	private  UtenteSRLZDAO() {}

	public static synchronized UtenteDAO getInstance() throws IOException {
		if(singletonUtenteDAO == null) 
			singletonUtenteDAO = new UtenteSRLZDAO();
