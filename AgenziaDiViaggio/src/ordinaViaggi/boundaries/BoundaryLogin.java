...
import ordinaViaggi.control.ControlloreLogin;
					...
					if (!controlloreLogin.verificaDati(usernameTextBox.getText(),
						...
						try {
							...
							//Utente trovato
								...
								//Setta lo username nella variabile statica per controlli successivi.
								AABoundaryAvvio.username = usernameTextBox.getText();
								AABoundaryAvvio.ruolo = ruolo;
