...
public class AABoundaryAvvio extends JFrame {
	...
	public void setButtons() {
		...
		if (AABoundaryAvvio.ruolo.equals("Amministratore")) {
		...
		} else if (AABoundaryAvvio.ruolo.equals("Promotore")) {
			cliente.setVisible(true);
			venditore.setVisible(true);
			gestoreEccezioni.setVisible(true);
			progettista.setVisible(true);
			promotore.setVisible(true);
		} else if (AABoundaryAvvio.ruolo.equals("Progettista")) {
			cliente.setVisible(true);
			venditore.setVisible(true);
			gestoreEccezioni.setVisible(true);
			progettista.setVisible(true);
		} else if (AABoundaryAvvio.ruolo.equals("GestoreEccezioni")) {
			cliente.setVisible(true);
			venditore.setVisible(true);
			gestoreEccezioni.setVisible(true);
		} else if (AABoundaryAvvio.ruolo.equals("Venditore")) {
			cliente.setVisible(true);
			venditore.setVisible(true);
		} else if (AABoundaryAvvio.ruolo.equals("Cliente")) {
			cliente.setVisible(true);
		} else {
