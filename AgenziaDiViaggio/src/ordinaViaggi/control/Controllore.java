...
public abstract class Controllore{
	...
	/*
	 * Legge una mappa, visibile solo dai controllori. Non capisco se la Map
	 * deve essere singleton o no...
	 */
	protected static Map readMap() throws MapDAOException {
	...
	protected static void saveMap(Map map) throws MapDAOException {
		map.save();
	}

	public static boolean verificaDati(List<String> list) {
	...
	private static boolean isInList(Collection<String> list, String keyToFind) {
		for (String key : list) {
			// La mappa cercata
	...
	private static SubElement getSubElementRecursive(Map map,
		...
		if (selectedList.isEmpty()) {
			...
			if (!isInList(collection, keyToFind))
	...
	private static SubElement getSubElement(List<String> selectedList,
	 ...
	 */
	public static String getInfo(List<String> selectedList, String key)
	...
	public static List<String> getTicket(List<String> selectedList, String key)
			throws MapDAOException {
		/*
	...
	private static void estrazioneMappaRecursive(Map map,
	...
	public static void estrazioneMappa(List<String> selectedList,
	 ...
	 * ne crea uno vuoto.
	 */
	protected static void inserimentoInMapRecursive(Map map,
	 ...
	 */
	protected static void rimozioneInMapRecursive(Map map, List<String> record,
	 ...
	 */
	protected static void printMapRecursive(Map map, int levelReached, int level) {
