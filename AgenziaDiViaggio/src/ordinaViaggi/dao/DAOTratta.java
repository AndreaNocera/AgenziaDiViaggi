...
public class DAOTratta extends DAO{
	...
	*/
	...
	/**
	 * La tratta non si occupa della gestione della tabella del Catalogo.
	 * Queste operazioni sono effettuate dal catalogo all'inizializzazione.
	 * La tratta si occupa di creare e inserire la tupla nel catalogo,
	 * chiamando gli altri DAO per l'inserimento nelle rispettive tabelle.
	 */
	private DAOTratta() {
		try {
	...
	public void insert(Object obj) throws DAOException {
		...
		try {
			...
			// Dopo l'inserimento della tupla richiama gli altri DAO 
			...
			daoAmbiente.insert(tratta.getAmbiente());
			daoMezzo.insert(tratta.getMezzo());
			daoCitta.insert(tratta.getCittaPartenza());
			daoCitta.insert(tratta.getCittaArrivo());
			daoVia.insert(tratta.getVia());
