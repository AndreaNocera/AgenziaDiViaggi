 ...
 */
public class DAOListaOfferta extends DAO{
private static DAOListaOfferta istance = null;
	...
	public static DAOListaOfferta getIstance() {
		if (istance == null)
			istance = new DAOListaOfferta();
		return istance;
	}
